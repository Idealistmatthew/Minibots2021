...
void loop() {
  // put your main code here, to run repeatedly:
    ...
    // (POTENTIALLY RESOLVED) ACTION POINT: CHECK MY CODE HERE AND MAYBE TRY IMPLEMENTING TURNING USING A FUNCITON WITH SOME USEFUL PARAMETERS LIKE SPEED OF TURN?
    // RESOLUTION: USE FUNCTIONS DEFINED FROM LIBRARY DIRECTLY instead of digitalWrite and analogueWrite functions

    // ACTION POINT: (ADVANCED) MAYBE INCLUDE PID TO MAKE IT BETTER? 
    //(IF THIS IS USED WE MIGHT NEED TO ALTER THE ORIGINAL FUNCTIONS, SO AS LONG AS THIS WORKS WELL, WE SHOULD ONLY TRY THIS IF WE HAVE COMPLETED ALL ASPECTS OF THE PROJECT)
